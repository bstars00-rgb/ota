...
(function(){
  ...
  const GOLF_COURSES = [
    ...
    // ===== 확장 코스 (2026-07) =====
    // Japan — 오키나와 남부 + 미야자키 + 홋카이도
    { id:'gc-jp-ryukyu',       name:'류큐 골프클럽',           country:'japan',      city:'okinawa',   holes:36, par:72, yardage:7020, designer:'-',              greens:'고려',  channelManager:'gdo',     realTimeBooking:true },
    { id:'gc-jp-pgm-okinawa',  name:'PGM 골프리조트 오키나와', country:'japan',      city:'okinawa',   holes:27, par:72, yardage:6912, designer:'-',              greens:'벤트',  channelManager:'gdo',     realTimeBooking:true },
    { id:'gc-jp-phoenix',      name:'피닉스 컨트리클럽',       country:'japan',      city:'miyazaki',  holes:27, par:72, yardage:7027, designer:'大久保昌',        greens:'고려',  channelManager:'gdo',     realTimeBooking:true },
    { id:'gc-jp-hokkaido-cl',  name:'홋카이도 클래식 GC',      country:'japan',      city:'sapporo',   holes:18, par:72, yardage:7059, designer:'Jack Nicklaus',  greens:'벤트',  channelManager:'gora',    realTimeBooking:true },
    // Vietnam — 하노이 + 나트랑
    { id:'gc-vn-skylake',      name:'스카이레이크 골프클럽',   country:'vietnam',    city:'hanoi',     holes:36, par:72, yardage:7178, designer:'-',              greens:'벤트',  channelManager:'direct',  realTimeBooking:true },
    { id:'gc-vn-vinpearl-nt',  name:'빈펄 골프 나트랑',        country:'vietnam',    city:'nhatrang',  holes:18, par:71, yardage:6787, designer:'IMG',            greens:'씨쇼어',channelManager:'partner', realTimeBooking:true },
    // Thailand — 치앙마이 + 푸켓
    { id:'gc-th-highlands',    name:'치앙마이 하이랜즈 골프&스파', country:'thailand',city:'chiangmai', holes:27, par:72, yardage:6947, designer:'Schmidt-Curley', greens:'씨쇼어',channelManager:'golfdigg',realTimeBooking:true },
    { id:'gc-th-laguna-hkt',   name:'라구나 골프 푸켓',        country:'thailand',   city:'phuket',    holes:18, par:71, yardage:6756, designer:'-',              greens:'씨쇼어',channelManager:'golfdigg',realTimeBooking:true },
    // Philippines — 마닐라
    { id:'gc-ph-southwoods',   name:'마닐라 사우스우즈 G&CC',  country:'philippines',city:'manila',    holes:36, par:72, yardage:7212, designer:'Jack Nicklaus',  greens:'버뮤다',channelManager:'partner', realTimeBooking:false }
  ];

  // 골프텔 도시 슬러그 → 한글 표기 (목록 드롭다운·카드·상세 브레드크럼)
  const GOLF_CITY_NAMES = {
    okinawa:'오키나와', fukuoka:'후쿠오카', miyazaki:'미야자키', sapporo:'삿포로',
    danang:'다낭', phuquoc:'푸꾸옥', nhatrang:'나트랑', hanoi:'하노이',
    bangkok:'방콕', pattaya:'파타야', chiangmai:'치앙마이', phuket:'푸켓',
    cebu:'세부', clark:'클락', manila:'마닐라', boracay:'보라카이',
    osaka:'오사카', tokyo:'도쿄'
  };
  ...
  const _GOLFTEL_GALLERIES = {
    ...
    // 확장 골프텔 (2026-07)
    'gt-jp-okinawa-ryukyu-2n':      [..._pick(_IMAGE_POOL.golf,[2,4,7]), ..._pick(_IMAGE_POOL.resort,[2,3,0,4]), _IMAGE_POOL.room[1]],
    'gt-jp-okinawa-pgm-3n':         [..._pick(_IMAGE_POOL.golf,[4,8,1]), ..._pick(_IMAGE_POOL.resort,[8,7,5,6]), _IMAGE_POOL.room[0]],
    'gt-jp-miyazaki-phoenix-3n':    [..._pick(_IMAGE_POOL.golf,[7,1,5]), ..._pick(_IMAGE_POOL.resort,[0,5,7,8]), _IMAGE_POOL.room[2]],
    'gt-jp-sapporo-classic-3n':     [..._pick(_IMAGE_POOL.golf,[8,2,0]), ..._pick(_IMAGE_POOL.resort,[1,4,3,2]), _IMAGE_POOL.room[1]],
    'gt-vn-danang-montgomerie-3n':  [..._pick(_IMAGE_POOL.golf,[1,6,3]), ..._pick(_IMAGE_POOL.resort,[6,7,5,8]), _IMAGE_POOL.room[0]],
    'gt-vn-nhatrang-vinpearl-4n':   [..._pick(_IMAGE_POOL.golf,[3,4,8]), ..._pick(_IMAGE_POOL.resort,[8,6,7,5]), _IMAGE_POOL.room[1]],
    'gt-vn-hanoi-skylake-3n':       [..._pick(_IMAGE_POOL.golf,[0,3,2]), ..._pick(_IMAGE_POOL.resort,[4,0,1,3]), _IMAGE_POOL.room[2]],
    'gt-th-chiangmai-highlands-3n': [..._pick(_IMAGE_POOL.golf,[6,5,1]), ..._pick(_IMAGE_POOL.resort,[5,2,6,0]), _IMAGE_POOL.room[0]],
    'gt-th-phuket-laguna-4n':       [..._pick(_IMAGE_POOL.golf,[5,0,4]), ..._pick(_IMAGE_POOL.resort,[7,8,6,5]), _IMAGE_POOL.room[1]],
    'gt-ph-manila-southwoods-3n':   [..._pick(_IMAGE_POOL.golf,[7,2,6]), ..._pick(_IMAGE_POOL.resort,[3,1,2,4]), _IMAGE_POOL.room[2]]
  };
  ...
  const _DEFAULT_FAQS = [
    ...
    { q:'예약 변경·취소 규정은 어떻게 되나요?',
      a:'출발 21일 전 무료 / 20~14일 전 30% / 13~7일 전 50% / 6~4일 전 80% / 3일 이내 100%입니다. 마이페이지 > 예약 내역에서 직접 취소할 수 있으며, 위약금·환불액이 자동 계산됩니다.' }
  ];
  ...
  const GOLFTELS = [
    ...
    // ===== 확장 골프텔 (2026-07) — 가격대·도시 다양화 =====
    // ----- JAPAN (직영) -----
    { id:'gt-jp-okinawa-ryukyu-2n', type:PRODUCT_TYPES.GOLFTEL,
      country:'japan', city:'okinawa',
      name:'오키나와 남부 류큐 골프 2박3일 (라운딩 2회)',
      tagline:'나하 공항 30분 · 36홀 명문 + 가성비 시내 호텔',
      hotelId:'h-ryukyu-naha',
      hotelName:'류큐 선셋 호텔 나하', roomType:'스탠다드 트윈',
      nights:2, rounds:2,
      courseIds:['gc-jp-ryukyu'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:false, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:748000, oldPricePerPerson:890000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'나하 시내 8km', airport:'나하 공항 14km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['restaurant','shuttle','driving-range'],
      rules:['셀프 라운딩 기준 (캐디 옵션)','국제거리 도보 10분', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1592919505780-303950717480?auto=format&fit=crop&w=1600&q=80'],
      highlights:['80만원 이하 오키나와 골프','공항 30분 접근성','국제거리 도보권'],
      includes:['나하 시내 호텔 2박 (조식 포함)','그린피·카트피 (2라운딩)','공항 왕복 픽업','골프장 셔틀'],
      excludes:['항공권','캐디피','석식','개인 경비'],
      rating:9.0, reviews:88 },

    { id:'gt-jp-okinawa-pgm-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'japan', city:'okinawa',
      name:'오키나와 PGM 리조트 3박4일 (라운딩 3회)',
      tagline:'27홀 리조트 코스 + 온나손 비치 리조트',
      hotelId:'h-onna-okinawa',
      hotelName:'온나손 비치 리조트', roomType:'디럭스 트윈 오션뷰',
      nights:3, rounds:3,
      courseIds:['gc-jp-pgm-okinawa','gc-jp-okinawa-cc'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:false, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:968000, oldPricePerPerson:1150000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'나하 시내 40km', airport:'나하 공항 50km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','beach','restaurant','shuttle','driving-range'],
      rules:['이틀째 오키나와CC 라운딩 (교차 코스)', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1606744824163-985d376605aa?auto=format&fit=crop&w=1600&q=80'],
      highlights:['2개 코스 교차 라운딩','온나손 비치 리조트','GDO 실시간 티타임'],
      includes:['온나손 리조트 3박 (조식 포함)','그린피·카트피 (3라운딩)','공항 왕복 픽업','골프장 셔틀'],
      excludes:['항공권','캐디피','석식','개인 경비'],
      rating:9.1, reviews:114 },

    { id:'gt-jp-miyazaki-phoenix-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'japan', city:'miyazaki',
      name:'미야자키 피닉스CC 3박4일 (라운딩 2회)',
      tagline:'던롭 피닉스 개최 명문 27홀 · 한국 골퍼의 성지',
      hotelId:'h-sheraton-miyazaki',
      hotelName:'쉐라톤 그랜드 오션 리조트', roomType:'디럭스 트윈 오션뷰',
      nights:3, rounds:2,
      courseIds:['gc-jp-phoenix'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:true, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:1150000, oldPricePerPerson:1340000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'미야자키 시내 12km', airport:'미야자키 공항 18km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','spa','restaurant','korean-staff','shuttle','driving-range'],
      rules:['투어 프로 대회(던롭 피닉스) 개최 코스','캐디 동반 필수 코스', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1531058020387-3be344556be6?auto=format&fit=crop&w=1600&q=80'],
      highlights:['던롭 피닉스 개최 코스','캐디피 포함','쉐라톤 리조트 온천'],
      includes:['쉐라톤 리조트 3박 (조식 포함)','그린피·카트피·캐디피 (2라운딩)','공항 왕복 픽업','골프장 셔틀'],
      excludes:['항공권','석식','개인 경비'],
      rating:9.5, reviews:203 },

    { id:'gt-jp-sapporo-classic-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'japan', city:'sapporo',
      name:'홋카이도 클래식 3박4일 (라운딩 2회)',
      tagline:'잭 니클라우스 설계 · 여름 시즌 한정 (5~10월)',
      hotelId:'h-sapporo-grand',
      hotelName:'삿포로 그랜드 호텔', roomType:'스탠다드 트윈',
      nights:3, rounds:2,
      courseIds:['gc-jp-hokkaido-cl'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:false, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:858000, oldPricePerPerson:990000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:['morning','afternoon'],
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'삿포로 시내 도보권', airport:'신치토세 공항 45km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['restaurant','fitness','shuttle'],
      rules:['5~10월 시즌 한정 운영 (동계 폐장)','잭 니클라우스 시그니처 코스', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1592822874642-9eb15b7a0c34?auto=format&fit=crop&w=1600&q=80'],
      highlights:['잭 니클라우스 설계','여름 20°C 쾌적 라운딩','삿포로 시내 관광 병행'],
      includes:['삿포로 그랜드 호텔 3박 (조식 포함)','그린피·카트피 (2라운딩)','공항 왕복 픽업','골프장 셔틀'],
      excludes:['항공권','캐디피','석식','개인 경비'],
      rating:9.2, reviews:76 },

    // ----- VIETNAM (직영) -----
    { id:'gt-vn-danang-montgomerie-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'vietnam', city:'danang',
      name:'다낭 몽고메리 링크스 3박4일 (라운딩 2회)',
      tagline:'링크스 명문 + 미케 비치 4성 · 다낭 가성비 골프텔',
      hotelId:'h-intercon-danang',
      hotelName:'미케 비치 부티크 호텔', roomType:'슈페리어 트윈 시티뷰',
      nights:3, rounds:2,
      courseIds:['gc-vn-montgomerie'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:true, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:768000, oldPricePerPerson:920000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트 (페어웨이 진입가능)', teeTimeWindows:['morning','afternoon','twilight','night'],
      operatingInfo:{ checkIn:'15:00', checkOut:'12:00', breakfast:'06:00~10:00',
        teeOff:{ morning:'05:30~10:30', afternoon:'11:00~13:30', twilight:'14:00~15:30', night:'17:00~19:00' }},
      distance:{ city:'다낭 시내 5km', airport:'다낭 공항 9km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','restaurant','korean-staff','shuttle'],
      rules:['한국인 캐디 100% 보장','야간 라운딩 가능 (16시 이후)', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?auto=format&fit=crop&w=1600&q=80'],
      highlights:['80만원 이하 다낭 골프','한국인 캐디 보장','링크스 스타일 명문'],
      includes:['미케 비치 호텔 3박 (조식 포함)','그린피·카트피·캐디피 (2라운딩)','공항 왕복 픽업','코스 셔틀'],
      excludes:['항공권','석식','캐디팁','개인 경비'],
      rating:9.3, reviews:167 },

    { id:'gt-vn-nhatrang-vinpearl-4n', type:PRODUCT_TYPES.GOLFTEL,
      country:'vietnam', city:'nhatrang',
      name:'나트랑 빈펄 아일랜드 골프 4박5일 (라운딩 3회)',
      tagline:'혼째섬 씨사이드 18홀 + 빈펄 럭셔리 리조트',
      hotelId:'h-vinpearl-nhatrang',
      hotelName:'빈펄 럭셔리 나트랑', roomType:'디럭스 오션뷰',
      nights:4, rounds:3,
      courseIds:['gc-vn-vinpearl-nt'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:true, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:998000, oldPricePerPerson:1240000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'나트랑 시내 (케이블카 10분)', airport:'깜란 공항 32km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','spa','beach','kidsclub','restaurant','korean-staff','shuttle','driving-range'],
      rules:['혼째섬 내 코스 — 리조트 셔틀 5분','케이블카·스피드보트 이동 포함', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?auto=format&fit=crop&w=1600&q=80'],
      highlights:['섬 전체가 리조트','씨사이드 시그니처 홀','빈원더스 입장 무료'],
      includes:['빈펄 리조트 4박 (조식 포함)','그린피·카트피·캐디피 (3라운딩)','빈원더스 입장권','공항 왕복'],
      excludes:['항공권','석식','캐디팁'],
      rating:9.3, reviews:186 },

    { id:'gt-vn-hanoi-skylake-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'vietnam', city:'hanoi',
      name:'하노이 스카이레이크 3박4일 (라운딩 2회)',
      tagline:'하노이 근교 36홀 + 시내 5성 · 최저가 직영 골프텔',
      hotelId:'h-sofitel-hanoi',
      hotelName:'소피텔 레전드 메트로폴 하노이', roomType:'프리미엄 트윈',
      nights:3, rounds:2,
      courseIds:['gc-vn-skylake'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:true, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:698000, oldPricePerPerson:850000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'하노이 구시가 도보권', airport:'노이바이 공항 28km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','spa','restaurant','korean-staff','shuttle'],
      rules:['한국인 캐디 100% 보장','스카이·레이크 36홀 교차 라운딩', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1530648787-d8e2e1cffa4f?auto=format&fit=crop&w=1600&q=80'],
      highlights:['60만원대 직영 골프텔','소피텔 레전드 5성','구시가 관광 병행'],
      includes:['소피텔 하노이 3박 (조식 포함)','그린피·카트피·캐디피 (2라운딩)','공항 왕복 픽업','코스 셔틀'],
      excludes:['항공권','석식','캐디팁','개인 경비'],
      rating:9.1, reviews:132 },

    // ----- THAILAND (파트너) -----
    { id:'gt-th-chiangmai-highlands-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'thailand', city:'chiangmai',
      name:'치앙마이 하이랜즈 골프 3박4일 (라운딩 2회)',
      tagline:'북부 고원 27홀 + 포시즌스급 리조트 · 겨울 골프 성지',
      hotelId:'h-fourseasons-cnx',
      hotelName:'포시즌스 리조트 치앙마이', roomType:'가든 파빌리온',
      nights:3, rounds:2,
      courseIds:['gc-th-highlands'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:false, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:648000, oldPricePerPerson:780000, priceBasis:'per-person-twin',
      cartPolicy:'1인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'치앙마이 올드시티 20km', airport:'치앙마이 공항 25km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','spa','restaurant','shuttle','driving-range'],
      rules:['11~2월 건기 베스트 시즌','고원 지대 — 최저 18°C 쾌적', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1606744837616-56c9a5c6a6eb?auto=format&fit=crop&w=1600&q=80'],
      highlights:['1인 1카트 기본','겨울 골프 최적지','포시즌스급 리조트'],
      includes:['포시즌스 리조트 3박 (조식 포함)','그린피·카트피 (2라운딩)','공항 왕복 픽업','골프장 셔틀'],
      excludes:['항공권','캐디피(500바트/R)','석식'],
      rating:9.4, reviews:158 },

    { id:'gt-th-phuket-laguna-4n', type:PRODUCT_TYPES.GOLFTEL,
      country:'thailand', city:'phuket',
      name:'푸켓 라구나 골프 4박5일 (라운딩 3회)',
      tagline:'방따오 비치 리조트 단지 내 18홀 + 島 휴양',
      hotelId:'h-vinsetsi-phuket',
      hotelName:'라구나 방따오 비치 리조트', roomType:'디럭스 라군뷰',
      nights:4, rounds:3,
      courseIds:['gc-th-laguna-hkt'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:false, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:1120000, oldPricePerPerson:1350000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'빠통 비치 25km', airport:'푸켓 공항 22km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['pool','spa','beach','kidsclub','restaurant','shuttle'],
      rules:['리조트 단지 내 코스 — 셔틀 5분','비치·수상 액티비티 병행', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1571896349842-33c89424de2d?auto=format&fit=crop&w=1600&q=80'],
      highlights:['단지 내 골프+비치','가족 동반 최적','라구나 셔틀 무료'],
      includes:['라구나 리조트 4박 (조식 포함)','그린피·카트피 (3라운딩)','공항 왕복 픽업','단지 셔틀'],
      excludes:['항공권','캐디피(500바트/R)','석식'],
      rating:9.2, reviews:129 },

    // ----- PHILIPPINES (파트너) -----
    { id:'gt-ph-manila-southwoods-3n', type:PRODUCT_TYPES.GOLFTEL,
      country:'philippines', city:'manila',
      name:'마닐라 사우스우즈 3박4일 (라운딩 2회)',
      tagline:'잭 니클라우스 36홀 + 마카티 시내 호텔 · 최저가 골프텔',
      hotelId:'h-makati-manila',
      hotelName:'마카티 시티 호텔', roomType:'스탠다드 트윈',
      nights:3, rounds:2,
      courseIds:['gc-ph-southwoods'],
      inclusions:{ greenFee:true, cartFee:true, caddyFee:true, golfShuttle:true, airportPickup:true, breakfast:true, dinner:false },
      pricePerPerson:598000, oldPricePerPerson:720000, priceBasis:'per-person-twin',
      cartPolicy:'2인 1카트', teeTimeWindows:_DEFAULT_TEE_WINDOWS,
      operatingInfo:_DEFAULT_OPERATING,
      distance:{ city:'마카티 시내 도보권', airport:'마닐라 공항 12km' },
      roomOptions:_DEFAULT_ROOM_OPTIONS,
      facilities:['fitness','restaurant','korean-staff','shuttle'],
      rules:['캐디 동반 필수 코스 (캐디피 포함)','마카티 → 코스 전용 셔틀 40분', ..._DEFAULT_RULES],
      images:['https://images.unsplash.com/photo-1606744824163-985d376605aa?auto=format&fit=crop&w=1600&q=80'],
      highlights:['50만원대 최저가','잭 니클라우스 36홀','직항 4시간'],
      includes:['마카티 호텔 3박 (조식 포함)','그린피·카트피·캐디피 (2라운딩)','공항 왕복 픽업','전용 셔틀'],
      excludes:['항공권','캐디팁(500페소/R)','석식'],
      rating:8.9, reviews:97 }
  ];
  ...
  root.DATA = {
    ...
    PRODUCTS, PRODUCT_TYPES, OWNERSHIP, GOLF_COURSES, GOLFTELS, CHANNEL_MANAGERS, GOLF_CITY_NAMES,
