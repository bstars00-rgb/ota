  ...
  const PRODUCTS = [
    {
      ...
      name:'[직영] 오사카 OMT 스테이 3박4일',
      subtitle:'티웨이항공 + OMT 오사카 직영 호텔 + 벚꽃 크루즈',
      flight:'f-TW283', hotel:'h-granvia-osaka', activities:['a-usj-1day','a-osaka-sakura'],
      nights:3, price:689000, oldPrice:890000, originalFlag:true, directRun:true,
    ...
    },
    {
      ...
      name:'[직영] 다낭 OMT 풀빌라 4박5일',
      subtitle:'비엣젯 + OMT 다낭 직영 풀빌라 + 조식/석식',
      flight:'f-VJ835', hotel:'h-premier-danang', activities:['a-danang-banahill','a-hoian-lantern'],
      nights:4, price:1290000, oldPrice:1590000, originalFlag:true, directRun:true,
    ...
    },
    {
      ...
      name:'[직영] 방콕 OMT 시티 5박6일',
      subtitle:'타이항공 + OMT 방콕 직영 부티크 + 파타야 연계',
      flight:'f-TG657', hotel:'h-novotel-bangkok', activities:['a-bkk-tour'],
      nights:5, price:890000, oldPrice:1180000, originalFlag:true, directRun:true,
    ...
    },
    {
      ...
      name:'[직영] 세부 OMT 리조트 4박5일',
      subtitle:'세부퍼시픽 + OMT 막탄 직영 리조트 + 호핑투어',
      flight:'f-5J187', hotel:'h-shangrila-mactan', activities:['a-cebu-hop','a-cebu-golf'],
      nights:4, price:1580000, oldPrice:1890000, originalFlag:true, directRun:true,
