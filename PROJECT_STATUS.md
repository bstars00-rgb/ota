...
| 파일 | 역할 | 내용 |
|---|---|---|
| `data.js` | 중앙 목데이터 | 4 국가 · 23 공항 · 13 항공사 · 34 항공편 · 25 호텔 · 25 액티비티 · 12 상품 · **8 골프텔** · **10 골프코스** · **국가 오너십 매트릭스** · **PRODUCT_TYPES enum** · 8 크리에이터 · 8 피드 · 8 리뷰 · 4 예약 · 5 쿠폰 · 6 포인트 · **4 크리에이터 등급** · **신규 보너스** · **크리에이터 통계** |
...
| # | 항목 | 설명 | 예상 작업량 |
|---|---|---|---|
| 1 | **골프텔 검색·리스트 페이지** (`golftels.html`) | 몽키 스타일 — 국가/도시/라운딩 횟수/가격 필터 · 직영/프랜차이즈 뱃지 노출 · 카드에 호텔+코스+포함사항 요약 | M |
| 2 | **골프텔 상세 페이지** | 호텔·코스·포함사항·라운딩 일정·픽업 동선 · `golftel-air` 옵션 토글 (항공 결합 시 별도 가격) | M |
| 3 | **메인 홈/국가 페이지 재편** | index/country.html 최상단을 골프텔로 끌어올림 · 직영국(일본·베트남) 우선 노출 | M |
| 4 | **크리에이터 대시보드 골프텔 반영** | 직영/프랜차이즈 판매 비중 게이지 · 골프텔 SKU 우선 추천 | S |
...
| # | 항목 | 설명 |
|---|---|---|
| 6 | **골프텔 빌더** (선택 옵션) | 호텔 베이스에 라운딩·픽업·식사·항공을 옵션으로 조립 (몽키엔 없는 차별점) |
| 7 | **액티비티 엑스트라넷 MVP** | 공급사가 티켓·렌트를 직접 등록·재고관리하는 백오피스 (목업) |
| 8 | **ELLIS 백엔드 연동 스펙** | data.js → ELLIS API 매핑 문서 (필드명·엔드포인트·스키마 차이) |
...
_Status snapshot 2026-05-20 · 17 pages · 2 JS modules · 6 docs · 골프텔 8 + 골프코스 10 + 오너십 매트릭스 · 기획 94 / QA 87 / 인터랙티브 96_
